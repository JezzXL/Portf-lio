...
const experiences: Experience[] = [
  {
    ...
    skills: ['Java', 'C#', 'SQL', 'React', 'TypeScript', 'Tailwind CSS', 'Design Gráfico', 'UI/UX', 'Redes Sociais'],
    icon: Code2
  },
  {
    id: 2,
    ...
    <section id="experience" className="py-20 bg-white dark:bg-[#0a0a0a] transition-colors">
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          >
            Minha trajetória profissional, desde o design até o desenvolvimento web
          </motion.p>
        </motion.div>
