...
const projects: Project[] = [
  ...
  description: 'Plataforma full-stack para gestão de aulas fitness com autenticação Firebase, painel admin completo, sistema de reservas com validação de capacidade e estatísticas em tempo real. Arquitetura escalável com gerenciamento de estado via Zustand.',
